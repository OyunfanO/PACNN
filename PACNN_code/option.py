...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/jiafan/PACNN/Dataset/',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='../test',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='DIV2K',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='BSD68',
...
parser.add_argument('--is_grey', type=int, default='1',
                    help='grey channel or y channel')   
parser.add_argument('--shuffle', type=int, default='0',
                    help='randomly sample from training data')

# Model specifications
parser.add_argument('--model', default='BSR',
                    help='model name')

parser.add_argument('--suffix', default='model_latest',
                    help='model used')
...
parser.add_argument('--testset', type=str, default='BSD68',
